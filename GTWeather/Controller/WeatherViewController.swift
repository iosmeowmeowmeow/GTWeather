...
extension WeatherViewController {
    func viewModelsForWeather(_ weather: Weather) -> [DetailViewModel] {
        return [
            ...
            DetailViewModel(title: "Pressure", details: "\(weather.pressure)"),
            DetailViewModel(title: "Humidity", details: "\(weather.humidity)"),
            DetailViewModel(title: "Average Temperature", details: "\(weather.temperatureAverage)"),
            DetailViewModel(title: "Lowest Temperature", details: "\(weather.temperatureMin)"),
            DetailViewModel(title: "Highest Temperature", details: "\(weather.temperatureMax)"),
            DetailViewModel(title: "Wind Speed", details: "\(weather.windSpeed)"),
            DetailViewModel(title: "Wind Direction", details: "\(weather.windDirection)")
        ]
    }
}
